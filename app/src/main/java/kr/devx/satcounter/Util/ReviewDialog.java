...
public class ReviewDialog implements DialogInterface.OnClickListener {
    ...
    public ReviewDialog(Context context, String supportEmail) {
    ...
    private void build() {
        ...
        dialogView = inflater.inflate(R.layout.review_dialog, null);
        reviewEmail = dialogView.findViewById(R.id.reviewEmail);
        reviewMessage = dialogView.findViewById(R.id.reviewMessage);
        ...
        ratingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                if (v < upperBound) {
                    reviewEmail.setVisibility(View.VISIBLE);
                    reviewMessage.setVisibility(View.VISIBLE);
                } else {
                    reviewEmail.setVisibility(View.GONE);
        ...
        if (i == DialogInterface.BUTTON_POSITIVE) {
            if (ratingBar.getRating() < upperBound) {
                if (negativeReviewListener == null) {
                    ...
                    negativeReviewListener.onNegativeReview((int) ratingBar.getRating(), reviewEmail.getText().toString(), reviewMessage.getText().toString());
                }
    ...
    public ReviewDialog setTitle(String title) {
        this.title = title;
        return this;

    }

    public ReviewDialog setSupportEmail(String supportEmail) {
        this.supportEmail = supportEmail;
        return this;
    }

    public ReviewDialog setRateText(String rateText) {
        this.rateText = rateText;
        return this;
    }

    public ReviewDialog setStarColor(int color) {
        starColor = color;
        return this;
    }

    public ReviewDialog setPositiveButtonText(String positiveButtonText) {
        this.positiveButtonText = positiveButtonText;
        return this;
    }

    public ReviewDialog setNegativeButtonText(String negativeButtonText) {
        this.negativeButtonText = negativeButtonText;
        return this;
    }

    public ReviewDialog setNeverButtonText(String neverButtonText) {
     ...
     * @return
     */
    public ReviewDialog setForceMode(boolean isForceMode) {
     ...
     * @return the dialog
     */
    public ReviewDialog setUpperBound(int bound) {
     ...
     * @return
     */
    public ReviewDialog setNegativeReviewListener(NegativeReviewListener listener) {
     ...
     * @return
     */
    public ReviewDialog setReviewListener(ReviewListener listener) {
        this.reviewListener = listener;
        return this;
    }

    public interface NegativeReviewListener {
        void onNegativeReview(int stars, String email, String message);
    }
